...
, ROUND(AVG(A.trip_total_distance_km) ,3) AS avg_line_total_distance_km
, ROUND(AVG(A.trip_total_time_min) ,3) AS avg_line_total_time_min
, ROUND(AVG(A.trip_avg_speed) ,3) AS avg_line_speed
